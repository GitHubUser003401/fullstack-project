...
import { createProblems, getProblemById, updateProblem } from '../service/api';
    ...
    return (
        <div className={className + "w-full animated-entry min-h-screen flex justify-center"}>
            <form onSubmit={handleSubmit} className="mt-[100px] w-2/3 mb-[50px] min-h-screen bg-gradient-to-br space-y-9 from-[#e6b93e] via-[#bebcb0] to-[#e6b93e] bordering flex flex-col items-center">
                ...
                <textarea placeholder="Type Sample Input In Order and Enter" className="focus:outline-none focus:ring-2 placeholder-black bg-gray-300 truncate w-2/3 h-16 transition delay-50 duration-500 hover:scale-105 hover:translate-y-1"
                ...
                <textarea placeholder="Type Sample Output In Order and Enter" className="focus:outline-none focus:ring-2 placeholder-black bg-gray-300  truncate w-2/3 h-16 transition delay-50 duration-500 hover:scale-105 hover:translate-y-1"

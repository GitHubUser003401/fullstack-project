    ...
    <div className={className}>
      <div className="flex justify-end opacity-90">
        <div className="w-1/3 h-screen mr-[100px] shadow-2xl shadow-orange-600 animated-gradient grid grid-rows-8 place-items-center text-wrap overflow-hidden">
          <h1 className="mt-[40px] row-start-1 font-imperialscript text-6xl text-purple-950 transition delay-50 duration-1000 hover:scale-110 animated-entry">Login to <span className="bg-gradient-to-r from-[#050505] via-[#af0000] to-[#5f5f5f] bg-clip-text text-transparent">Codelite</span></h1>
          <h2 className="row-start-3 italic text-lg text-amber-800 drop-shadow-lg font-tomorrow uppercase animated-entry">Enter your credentials</h2>

...
function Home({className}) {
    ...
    return (
        ...
        <div className= " animated-entry flex justify-between h-screen">
            <h1 className = "mt-[150px] font-serif w-2/5 text-red-200 font-semibold text-4xl">
                Let's learn Something New Today! <br /> <br />
                Welcome, <br /> <span className = "text-amber-600">
                {data?.user?.username}
                </span>
            </h1>
            ...
            <p className = " w-72 h-40 mt-[40px] text-center font-serif text-2xl text-[#844e1c] transition delay-50 duration-1000 ease-in-out hover:scale-110 hover:text-[#ed4545]">
